...
This repo now includes root-level `requirements.txt`, `Procfile`, and `nixpacks.toml` so Railpack can detect Python automatically even if Root Directory is not set.
